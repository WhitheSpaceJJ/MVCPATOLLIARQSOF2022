...
public class Partida implements Serializable {
    ...
    public Partida(Jugador turno, Tablero tablero, double montoJugador, double montoApuesta, int totalJugadores, int cantidadFichas) {
//       turno.inicializarFichas(6);
        turno.setDinero(new Dinero(montoJugador));
        turno.inicializarFichas(cantidadFichas);
