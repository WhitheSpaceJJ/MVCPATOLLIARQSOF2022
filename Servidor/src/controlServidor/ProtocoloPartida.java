...
//
//
//    private  int[] indicesCentro14 = {30, 0, 15, 45};
//
//    private  int[] indicesCentro12 = {26, 0, 12, 39};
//
//    private  int[] indicesCentro10 = {22, 0, 11, 33};
...
//                }
            ...
            //La variable next es utilizada para determinar si se va pasar el siguiente turno, de acuerdo a la otra logica
            if (next == 0) {
...
//this.partidaLocal.actualizarPartida();
//        } else {
//            indiceCasilla = arregloAuxiliar[indiceJugador] + avance;
//            Casilla casilla = tablero.getCasillas().get(indiceCasilla);
//            List<Casilla> casillas = tablero.getCasillas();
