...
//            Partida partida = ((PartidaServidor) o).getPartidaLocal();
//            puntero = partida.getJugadores().indexOf(partida.getTurno());
//            notificarClientes(partida, ((Integer) o1));
//            if (((Integer) o1) == -1) {
...
//                Object object = null;
//                try {
//                    ObjectInputStream inputd = new ObjectInputStream(jugadores.get(puntero).getSocket().getInputStream());
//                    object = inputd.readObject();
//                } catch (IOException | ClassNotFoundException e) {
//                    System.out.println("Error; " + e.getMessage());
//                }
//                this.protocoloPartidaLocal.procesarDados(object);
//            }
...
//Reactualizacion del servidor patolli
